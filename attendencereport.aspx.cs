...
namespace WebApplication1
{
    public partial class attendencereport : System.Web.UI.Page
    {
        ...
        protected void bindReport()
        {
            ...
            con.Open();
            MySqlDataAdapter da = new MySqlDataAdapter("select * from attendence", con);


            DataTable dt = new DataTable("DataTable8");
            da.Fill(dt);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("Report15.rdlc");
